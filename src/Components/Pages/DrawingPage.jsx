...
export const DrawingPage = ({changeState, json, setJson, filename}) => {
  ...
  const saveJSON = () => {
    ...
    workingJson.settings.defaultColor = defaultColor
    downloadJSON(workingJson, filename)
    setWorkingJson(JSON.parse(JSON.stringify(workingJson)))
    setJson(workingJson)
  }
  ...
  return (
    <div className="flex h-full aspect-video justify-center items-center font-playfair">
      <div className="flex h-fit justify-center items-center gap-8">
        ...
        <div className="bg-white flex-1 flex flex-col items-center p-2 rounded-2xl h-[80vh] overflow-hidden">
        ...
        <div className="flex h-full flex-col gap-2 rounded-2xl justify-between">
          <div className="flex items-center p-4 rounded-2xl bg-white">
            ...
            <div className="flex flex-col gap-4 p-4 rounded-2xl font-mono text-black" style={{backgroundColor: selectedColor}}>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="w-full flex px-2 justify-between">
                  <button className="p-2 rounded-full bg-neutral-100 hover:scale-110 hover:bg-neutral-200 border border-black" onClick={() => setSelectedColor(drawingColor)}>
                  ...
                  <button className="p-2 rounded-full bg-neutral-100 hover:scale-110 hover:bg-neutral-200 border border-black" onClick={() => {setDrawingColor(selectedColor); setSelectedColor(defaultColor)}}>
                  ...
                  <button className="p-2 rounded-full bg-neutral-100 hover:scale-110 hover:bg-neutral-200 border border-black" onClick={() => {setCallBack("FILL"); setDefaultColor(selectedColor)}}>
                  ...
                  <button className="p-2 rounded-full bg-neutral-100 hover:scale-110 hover:bg-neutral-200 border border-black" onClick={() => setCallBack("SAMPLE")}>
                    <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>eyedropper</title><path d="M19.35,11.72L17.22,13.85L15.81,12.43L8.1,20.14L3.5,22L2,20.5L3.86,15.9L11.57,8.19L10.15,6.78L12.28,4.65L19.35,11.72M16.76,3C17.93,1.83 19.83,1.83 21,3C22.17,4.17 22.17,6.07 21,7.24L19.08,9.16L14.84,4.92L16.76,3M5.56,17.03L4.5,19.5L6.97,18.44L14.4,11L13,9.6L5.56,17.03Z" /></svg>
                  </button>
                </div>

                <div className="w-full flex px-2 justify-center items-center gap-2">
                  <button className="bg-neutral-100 rounded-lg hover:scale-125 p-1 w-7 h-7" onClick={() => {setCallBack("GRID"); setGrid(!grid)}}>
                    {grid ?
                  ...
                  <button className="text-sm p-2 rounded-xl flex-1 bg-neutral-100 hover:scale-110 hover:bg-neutral-200 border border-black" onClick={() => {setCallBack("CLEAR"); setEditingTile("")}}>
                    Clear
                  </button>
                  <button className="text-sm p-2 rounded-xl flex-1 bg-neutral-100 hover:scale-110 hover:bg-neutral-200 border border-black" onClick={() => setCallBack("SAVE")}>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="w-full flex h-14 gap-2">
                ...
                <button className="primary-button p-2" onClick={() => {generateJSON(); changeState("GENERATING")}}>
